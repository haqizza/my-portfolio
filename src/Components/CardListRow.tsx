...
const CardListRow = (props: Props) => {
    ...
    return(
        <div id="listContainer" className="mt-14 mb-4 mx-4 p-4 text-white">
            ...
            <div className="flex flex-row overflow-auto no-scrollbar scroll-smooth">
                <div id="componentList" className="flex flex-row justify-start">
                    { cardComponents }
                </div>
            </div>
        </div>
